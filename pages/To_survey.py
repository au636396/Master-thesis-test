...
with col2:
    ...
    st.write("Jeg vil gerne stille dig nogle spørgsmål omkring cookie pop-ups og databeskyttelse. Det ville tage ca. 5 minuter. Hvis du gerne vil hjælpe mig med det, så klik her:")
    st.write()
